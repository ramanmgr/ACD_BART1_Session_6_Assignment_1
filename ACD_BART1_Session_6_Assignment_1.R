...
#that represent families and represent using appropriate visualization graph. 


pass_titles <- ""
for(i in 1:891){pass_titles <- c(pass_titles,pass_names[[i]][2])}
...
#create two different graphs showing Age distribution before and after imputation. 
